...
const INPUT: &str = include_str!("../../inputs/9/input.data");

pub(crate) fn get_9_first() -> usize {
    let commands = parse(INPUT);
    number_of_unique_positions_visited_by_tail(commands, 2)
}

pub(crate) fn get_9_second() -> usize {
    let commands = parse(INPUT);
