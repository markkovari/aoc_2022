const EXAMPLE: &str = include_str!("../../inputs/19/input.example");
const PROD: &str = include_str!("../../inputs/19/input.data");
...
fn parse(content: &str) -> Vec<[[u16; 4]; 4]> {
...
mod test_18 {
    ...
    fn test_example_part_1() {
        ...
        assert_eq!(example_part_1, 33);
    }

    #[test]
    fn test_example_part_2() {
        let example_part_2 = part_2(EXAMPLE);
        assert_eq!(example_part_2, 3472);
    }

    #[test]
    fn test_prod_part_1() {
        let prod_part_1 = part_1(PROD);
        assert_eq!(prod_part_1, 1418);
    }

    #[test]
    fn test_prod_part_2() {
        let prod_part_2 = part_2(PROD);
        assert_eq!(prod_part_2, 4114);
    }
}
